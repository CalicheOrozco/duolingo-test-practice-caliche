    ...
    <div className="bg-gray-900 px-4 py-8 min-h-[10vh] min-w-full">
      <div className="flex md:flex-row justify-between items-center">
        ...
        <Link to="/real-words-test">
          ...
          <Link to="/interactive-reading">
            <span
              className={
                pathname === "/interactive-reading"
                  ? ` text-orange-600 font-bold`
                  : `lg:hover:text-slate-400`
              }
            >
          ...
          <Link to="/interactive-listening">
            <span
              className={
                pathname === "/interactive-listening"
                  ? ` text-orange-600 font-bold`
                  : `lg:hover:text-slate-400`
              }
            >
          ...
          <Link to="/read-then-speak">
            <span
              className={
                pathname === "/read-then-speak"
                  ? ` text-orange-600 font-bold`
                  : `lg:hover:text-slate-400`
              }
            >
