                  ...
                  {correctList.length > 0 && (
                    <>
                      ...
                      {correctList.map((rec, idx) => (
                        <div key={`corr-${idx}`}>{renderSentenceWithAnswers(rec.sentence, [], rec.expected, rec.received)}</div>
                      ))}
                    </>
                  )}
                </div>
                  ...
                  {wrongList.length > 0 && (
                    <>
                      ...
                      {wrongList.map((rec, idx) => (
                        <div key={`wrong-${idx}`}>{renderSentenceWithAnswers(rec.sentence, [], rec.expected, rec.received)}</div>
                      ))}
                    </>
                  )}
                </div>
